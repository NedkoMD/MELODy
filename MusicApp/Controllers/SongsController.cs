...
namespace MusicApp.Controllers
{
    public class SongsController : Controller
    {
        ...
        public SongsController(MusicAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string songGenre, string searchString)
        {
            ...
            {
                return Problem("Entity set 'MusicAppContext.Song'  is null.");
            }
            ...
            var movieGenreVM = new SongGenreViewModel
            {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,SongName,Artist,Genre,ReleaseDate,URL")] Song song)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["success"] = "Song edited successfully!";
                }
